...
! function () {
    ...
    var c = function () {
        ...
        }], (i = null) && p(t.prototype, i), o && p(t, o), Object.defineProperty(t, "prototype", {
            writable: !1
        }), e
    }();
        ...
        A = function () {
            ...
            return t = e, o = [{
                ...
                value: function (e) {
                    ...
                    c.setAttrFromEle(t, n, Object.keys(x), k), t.parentNode.insertBefore(n, t), t.remove(), e.ele = n, e.options = s, e.disabledOptions = i, e.selectedValue = o
                }
            }, {
                key: "onFormReset",
                value: function (e) {
                ...
                value: function (e) {
                    ...
                    if (i) {
                        ...
                        return this.$dropboxWrapper = s, this.hasDropboxWrapper = !0, s.innerHTML = o, i.appendChild(s), c.addClass(s, "vscomp-dropbox-wrapper ".concat(t)), ""
                    }
                ...
                value: function (e, t, i) {
                    ...
                    e && s.removeArrayEmpty(t.split(" ")).forEach((function (t) {
                        var s = "".concat(i, "-").concat(t),
                            n = o.events[s];
                        n || (n = o[i].bind(o), o.events[s] = n), c.addEvent(e, t, n)
                    }))
                }
            }, {
                key: "onDocumentClick",
                ...
                value: function (e) {
                    var t = e.which || e.keyCode,
                        i = w[t];
                    document.activeElement === this.$searchInput && (9 === t || e.shiftKey && 9 === t) ? this.closeDropbox() : document.activeElement !== this.$wrapper || 27 !== t && "Escape" !== e.key || !this.showAsPopup ? i && this[i](e) : this.closeDropbox()
                }
            }, {
                key: "onEnterPress",
                value: function (e) {
                ...
                value: function (e) {
                    ...
                    t && !c.hasClass(t, "disabled") && (c.hasClass(t, "group-title") ? this.onGroupTitleClick(t) : this.selectOption(t, {
                        event: e
                    }))
                }
            }, {
                ...
                value: function (e) {
                    var t = e.target.closest(".vscomp-option");
                    t && this.isOpened() && (c.hasClass(t, "disabled") || c.hasClass(t, "group-title") ? this.removeOptionFocus() : this.focusOption({
                        $option: t
                    }))
                }
            }, {
                ...
                value: function () {
                    var e = this.getVisibleOptions(),
                        ...
                        i = !t && !e.length;
                    (!this.allowNewOption || this.hasServerSearch || this.showOptionsOnlyOnSearch) && c.toggleClass(this.$allWrappers, "has-no-search-results", i), c.toggleClass(this.$allWrappers, "has-no-options", t), this.setOptionAttr(), this.setOptionsPosition(), this.setOptionsTooltip()
                }
            }, {
                ...
                value: function () {
                    ...
                    var O = function t(O) {
                        ...
                        if (g || "" !== x || (g = !0), o && (C.isDisabled = !0 === m[x]), O.isGroupOption && (C.isGroupOption = !0, C.groupIndex = O.groupIndex), u && (C.description = h(p(O[a]))), O.customData && (C.customData = O.customData), i.push(C), y += 1, E) {
                            var A = C.index;
                    ...
                    var S = i.length,
                        x = this.$ele;
                    x.options = i, x.length = S, this.options = i, this.visibleOptionsCount = S, this.lastOptionIndex = S - 1, this.newValues = [], this.hasOptionGroup = b, this.hasEmptyValueOption = g, this.setSortedOptions()
                }
            }, {
                ...
                value: function () {
                    ...
                    s ? (this.setVisibleOptionsCount(), this.multiple && this.toggleAllOptionsClass(), this.setValueText()) : this.updatePosition(), c.removeClass(this.$allWrappers, "server-searching")
                }
            }, {
                ...
                value: function () {
                    ...
                    })), o && (e = [o].concat(b(e))), this.visibleOptions = e, this.renderOptions()
                }
            }, {
                key: "setOptionsPosition",
                value: function (e) {
                    var t = (e || this.getVisibleStartIndex()) * this.optionHeight;
                    this.$options.style.transform = "translate3d(0, ".concat(t, "px, 0)"), c.setData(this.$options, "top", t)
                }
            }, {
                ...
                value: function () {
                    ...
                    t.forEach((function (t) {
                        ...
                        c.setData(o.querySelector(".vscomp-option-text"), "tooltip", t.label), i && c.setData(o.querySelector(".vscomp-option-description"), "tooltip", t.description)
                    }))
                }
            }, {
                key: "setValue",
                value: function (e) {
                    ...
                    a ? Array.isArray(e) ? this.selectedValues = b(e) : this.selectedValues = [e] : this.selectedValues = [];
                    var l = this.getValue();
                ...
                value: function () {
                    ...
                    if (u && this.hideValueTooltipOnSelectAll) s.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(a, ")");
                    else {
                        ...
                        var p = a - i;
                        p > 0 && r.push('<span class="vscomp-value-tag more-value-count">+ '.concat(p, " ").concat(this.moreText, "</span>"));
                        var h = n.join(", ");
                        if ("" === h) s.innerHTML = this.placeholder;
                        else if (s.innerHTML = h, e) {
                            var d = this.maxValues;
                            if (this.alwaysShowSelectedOptionsCount || c.hasEllipsis(s) || d || o) {
                    ...
                    var y = "";
                    0 === a ? y = this.placeholder : o || (y = r.join(", ")), c.setData(s, "tooltip", y), e && (c.setData(s, "tooltipEllipsisOnly", 0 === a), o && this.updatePosition())
                }
            }, {
                key: "setSearchValue",
                value: function (e) {
                    ...
                    if (e !== this.searchValueOriginal || i) {
                        ...
                        this.searchValue = o, this.searchValueOriginal = e, c.toggleClass(this.$allWrappers, "has-search-value", e), this.afterSetSearchValue()
                    }
                }
            }, {
                ...
                value: function () {
                    ...
                    e && (this.showAsPopup ? t["max-width"] = e : i.width = e), c.setStyles(this.$dropboxContainer, i), c.setStyles(this.$dropbox, t)
                }
            }, {
                key: "setOptionAttr",
                value: function () {
                ...
                value: function (e, t) {
                    ...
                    do {
                        o && (o = o[i])
                    } while (c.hasClass(o, "disabled") || c.hasClass(o, "group-title"));
                    return o
                }
            }, {
                key: "getUniqueId",
                ...
                key: "openDropbox",
                value: function (e) {
                    this.isSilentOpen = e, e ? c.setStyle(this.$dropboxContainer, "display", "inline-flex") : (c.dispatchEvent(this.$ele, "beforeOpen"), c.setAria(this.$wrapper, "expanded", !0)), this.setDropboxWrapperWidth(), c.removeClass(this.$allWrappers, "closed"), c.changeTabIndex(this.$allWrappers, 0), this.dropboxPopover && !e ? this.dropboxPopover.show() : this.afterShowPopper()
                }
            }, {
                key: "afterShowPopper",
                value: function () {
                    var e = this.isSilentOpen;
                    this.isSilentOpen = !1, e || (this.moveSelectedOptionsFirst(), this.setScrollTop(), c.addClass(this.$allWrappers, "focused"), this.showAsPopup ? (c.addClass(this.$body, "vscomp-popup-active"), this.isPopupActive = !0) : this.focusSearchInput(), c.dispatchEvent(this.$ele, "afterOpen"))
                }
            }, {
                key: "closeDropbox",
                value: function (e) {
                    this.isSilentClose = e, this.keepAlwaysOpen ? this.removeOptionFocus() : (e ? c.setStyle(this.$dropboxContainer, "display", "") : (c.dispatchEvent(this.$ele, "beforeClose"), c.setAria(this.$wrapper, "expanded", !1), c.setAria(this.$wrapper, "activedescendant", "")), this.dropboxPopover && !e ? this.dropboxPopover.hide() : this.afterHidePopper())
                }
            }, {
                key: "afterHidePopper",
                value: function () {
                    var e = this.isSilentClose;
                    this.isSilentClose = !1, c.removeClass(this.$allWrappers, "focused"), this.removeOptionFocus(), !e && this.isPopupActive && (c.removeClass(this.$body, "vscomp-popup-active"), this.isPopupActive = !1), c.addClass(this.$allWrappers, "closed"), e || (c.dispatchEvent(this.$ele, "afterClose"), this.focus())
                }
            }, {
                ...
                value: function () {
                    ...
                    if (o) e = o;
                        ...
                        e = this.$dropboxContainer.querySelector('.vscomp-option[data-visible-index="'.concat(r, '"]')), (c.hasClass(e, "disabled") || c.hasClass(e, "group-title")) && (e = this.getSibling(e, "next"))
                    } else e = this.getSibling(n, i);
                    e && e !== n && (n && this.toggleOptionFocusedState(n, !1), this.$ariaLiveElem && (this.$ariaLiveElem.textContent = e.textContent), this.toggleOptionFocusedState(e, !0), this.toggleFocusedProp(c.getData(e, "index"), !0), this.moveFocusedOptionToView(e))
                }
            }, {
                ...
                value: function (e) {
                    ...
                    if (t) {
                        ...
                        n > l ? i = h + d : r < u && (i = h - a + p + d), void 0 !== i && (this.$optionsContainer.scrollTop = i)
                    }
                }
            }, {
                    ...
                    if (e) {
                        ...
                        if (this.lastSelectedOptionIndex = null, this.toggleSelectedProp(a, o), o) {
                            if (this.multiple) n.push(r), this.toggleAllOptionsClass(), this.toggleGroupOptionsParent(e), i && i.shiftKey && (u = !0);
                                ...
                                var h = this.$dropboxContainer.querySelector(".vscomp-option.selected");
                                h && this.toggleOptionSelectedState(h, !1), this.closeDropbox(), l || this.setSearchValue("")
                            }
                        ...
                        l && this.beforeSelectNewValue(), this.setValue(n), u && this.selectRangeOptions(p, a)
                    }
                }
            }, {
                ...
                value: function (e) {
                    if (this.multiple && !this.disableSelectAll) {
                        var t = "boolean" == typeof isSelected ? e : !c.hasClass(this.$toggleAllCheckbox, "checked"),
                            i = [],
                ...
                value: function (e) {
                    if (this.multiple) {
                        var t = !1;
                        "boolean" == typeof e || (e = this.isAllOptionsSelected()), !e && this.selectAllOnlyVisible && (t = this.isAllOptionsSelected(!0)), c.toggleClass(this.$toggleAllCheckbox, "checked", e || t), this.isAllSelected = e
                    }
                }
            }, {
                ...
                value: function () {
                    ...
                    this.options.forEach((function (e) {
                        ...
                        disableValidation: e
                    }), this.afterValueSet(), e && c.removeClass(this.$allWrappers, "has-error"), c.dispatchEvent(this.$ele, "reset")
                }
            }, {
                key: "addOption",
                value: function (e, t) {
                ...
                value: function (e) {
                    ...
                    return !t.isGroupTitle || n && c || (c = s[t.index]), r || !p || c || (c = p.includes(i)), r || !u || c || (c = u.toLowerCase().includes(i)), t.isVisible = c, o || (o = l === i || a === i), {
                        isVisible: c,
                        hasExactOption: o
                    }
                }
                ...
                key: "serverSearch",
                value: function () {
                    c.removeClass(this.$allWrappers, "has-no-search-results"), c.addClass(this.$allWrappers, "server-searching"), this.setSelectedOptions(), this.onServerSearch(this.searchValue, this)
                }
            }, {
                key: "removeValue",
                value: function (e) {
                ...
                key: "enable",
                value: function () {
                    this.$ele.disabled = !1, this.$ele.removeAttribute("disabled"), this.$hiddenInput.removeAttribute("disabled"), c.setAria(this.$wrapper, "disabled", !1)
                }
            }, {
                key: "disable",
                value: function () {
                    this.$ele.disabled = !0, this.$ele.setAttribute("disabled", ""), this.$hiddenInput.setAttribute("disabled", ""), c.setAria(this.$wrapper, "disabled", !0)
                }
            }, {
                key: "validate",
                value: function () {
                    ...
                    var e = !1,
                        t = this.selectedValues,
                        i = this.minValues;
                    return this.required && (s.isEmpty(t) || this.multiple && i && t.length < i) && (e = !0), c.toggleClass(this.$allWrappers, "has-error", e), !e
                }
            }, {
                key: "destroy",
                value: function () {
                    var e = this.$ele;
                    e.virtualSelect = void 0, e.value = void 0, e.innerHTML = "", this.hasDropboxWrapper && (this.$dropboxWrapper.remove(), this.mutationObserver.disconnect()), this.dropboxPopover && this.dropboxPopover.destroy(), c.removeClass(e, "vscomp-ele")
                }
            }, {
                ...
                value: function (e, t) {
                    var i = t;
                    void 0 === i && (i = !c.hasClass(e, "selected")), c.toggleClass(e, "selected", i), c.setAria(e, "selected", i)
                }
            }, {
                key: "toggleOptionFocusedState",
                value: function (e, t) {
                    e && (c.toggleClass(e, "focused", t), t && c.setAria(this.$wrapper, "activedescendant", e.id))
                }
            }]) && O(t.prototype, i), o && O(t, o), Object.defineProperty(t, "prototype", {
                writable: !1
            }), e
        }();
    document.addEventListener("reset", A.onFormReset), document.addEventListener("submit", A.onFormSubmit), window.addEventListener("resize", A.onResizeMethod), x = A.getAttrProps(), window.VirtualSelect = A, "undefined" != typeof NodeList && NodeList.prototype && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach)
}(),
    function () {
        "use strict";
                ...
                return (t = [{
                    ...
                    value: function () {
                        ...
                        var G = {
                            ...
                            N = G[C];
                        if (E = N.top, k = N.left, A && ("top" === A ? E = x : "bottom" === A ? E = x + b - c : "left" === A ? k = w : "right" === A && (k = w + y - p)), k < M ? "left" === C ? n = "right" : k = M + f > g ? g - f : M : k + p > F && ("right" === C ? n = "left" : k = F + f < S ? S - d : F - p), E < P ? "top" === C ? n = "bottom" : E = P + h > O ? O - h : P : E + c > I && ("bottom" === C ? n = "top" : E = I + h < m ? m - v : I - c), n) {
                            var H = G[n];
                            "top" === (C = n) || "bottom" === C ? E = H.top : "left" !== C && "right" !== C || (k = H.left)
                        }
                        ...
                        if (i.setStyle(this.$popperEle, "transform", j), i.setData(this.$popperEle, "fromLeft", t), i.setData(this.$popperEle, "fromTop", e), i.setData(this.$popperEle, "top", E), i.setData(this.$popperEle, "left", k), i.removeClass(this.$popperEle, o.join(" ")), i.addClass(this.$popperEle, "position-".concat(C)), this.hasArrow) {
                            var W = 0,
                                ...
                                K = s[C] || "";
                            "top" === C || "bottom" === C ? (W = y / 2 + S - R) < B ? W = B : W > p - B && (W = p - B) : "left" !== C && "right" !== C || ((q = b / 2 + m - z) < B ? q = B : q > c - B && (q = c - B)), i.setStyle(this.$arrowEle, "transform", "translate3d(".concat(W, "px, ").concat(q, "px, 0) ").concat(K))
                        }
